...
-(void)viewDidLoad{
    ...
    [super viewDidLoad];
    [self.busNavigationBar removeFromSuperview];
...
-(QRCodeBacgrouView *)backgroundView{
    ...
    if (!_backgroundView) {
        ...
        _backgroundView = [[QRCodeBacgrouView alloc]initWithFrame:CGRectMake(0, 0, MAINWIDTH, MAINHEIGHT - [JHLiveAdaptUI heightOfEmptyBottom])];
    }
